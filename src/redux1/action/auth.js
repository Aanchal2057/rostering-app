...
export const getEventFilter = (val) => async (dispatch) => {
    try {
        ...
        dispatch({ type: GET_FILTER_FAIL, payload: error.message })
    }
}
...
export const generateInvoice = (uuid) => async (dispatch) => {
    try {
        ...
        dispatch({ type:GENERATE_INVOICE_FAIL, payload: error.message })
    }
}

export const createInvoice = ({ staff_id }) => async (dispatch) => {
    try {
        ...
        dispatch({ type: CREATE_INVOICE_FAIL, payload: error.response.data.message })
    }
}
...
export const getStaffInvoice = (id) => async (dispatch) => {
    try {
        ...
        dispatch({ type:GET_INVOICE_FAIL, payload: error.message })
    }
}
...
export const getCompleted = () => async (dispatch) => {
    try {
        ...
        dispatch({ type:GET_COMPLETED_FAIL, payload: error.message })
    }
}
...
export const generateClientInvoice = () => async (dispatch) => {
    try {
        ...
        dispatch({
            type: GENERATE_CLIENT_INVOICE_SUCCESS,
            payload: data
        })
    } catch (error) {
        dispatch({ type:GENERATE_CLIENT_INVOICE_FAIL, payload: error.message })
    }
}
...
export const getCleintInvoice = (id) => async (dispatch) => {
    try {
        ...
        dispatch({ type:GET_CLIENT_INVOICE_FAIL, payload: error.message })
    }
}